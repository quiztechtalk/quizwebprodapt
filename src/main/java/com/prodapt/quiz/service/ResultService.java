...
public class ResultService {
	...
	public String getMarks(@RequestBody String answerData,@RequestHeader(value="token") String token) throws CustomQuizException, JSONException, JsonGenerationException, JsonMappingException, IOException{
